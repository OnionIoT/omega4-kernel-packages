...
/*
 * OpenWrt builds this driver against backported cfg80211/mac80211 headers
 * whose API version can differ from the running kernel version.
 * Use the backport version code for driver-side version guards.
 */
#if defined(AIC_LINUX_VERSION_CODE) && AIC_LINUX_VERSION_CODE > 0
#undef LINUX_VERSION_CODE
#define LINUX_VERSION_CODE AIC_LINUX_VERSION_CODE
#elif defined(CFG80211_VERSION_CODE) && CFG80211_VERSION_CODE > 0
#undef LINUX_VERSION_CODE
